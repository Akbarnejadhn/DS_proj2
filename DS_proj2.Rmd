...
$$
outstae = 5935.99 + 0.80(accept)-3.11(enroll)+20.49(top10perc)-3.76(top25perc)+ 0.01(f undergrad)-0.04(p undergrad)
+0.63(room board)-0.29(books)-0.4(personal)+46.27(s f ratio)+35.58(perc alumni)+24.87(grad rate) +s(terminal)+s(expend)+s(phD)
$$
